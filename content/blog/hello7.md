---
title: لاراول - Mass Assignment
description: وقتی میخوایم آرایه ای از داده ها رو به صورت یکجا به یک مدل بفرستیم، به این عمل mass assignment میگن. معمولا لازم نیس اطلاعات رو یکی یکی ذخیره کنیم و میتونیم توی یه پروسه این کار رو انجام بدیم.
img: https://files.virgool.io/upload/users/36797/posts/kbixmky42ffm/souu4foxawoc.png
alt: استفاده از جیمیل
...
<h1 class="has-text-centered title is-1">لاراول - Mass Assignment</h1>
...
![The San Juan Mountains are beautiful!](https://files.virgool.io/upload/users/36797/posts/kbixmky42ffm/souu4foxawoc.png "San Juan Mountains")